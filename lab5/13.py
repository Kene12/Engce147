...
class Manager(Employee):
    ...
    def annual_salary(self):
        return (self.salary * 12) + self.bonus # ของ manager จะมี bonus การทำงานนำมาบวกกับเงินประจำปี
...
class Developer(Employee):
    ...
    def annual_salary(self):
        ...
        return base_salary + (self.projects * 1000) # ของ developer จะมีค่า projects การทำงานนำมาบวกกับเงินประจำปี
